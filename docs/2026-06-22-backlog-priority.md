...
**当前最该启动的是 PR12**:PR10 已补 fake/M5 consumer CLI 体验;PR9 已在 #17 底盘上接真实 reviewer pilot;PR11 已补 native-claude headless reviewer partial。PR12 负责把 runtime/session matrix 做成 consumer-visible report。其余全是参考素材或远期工作。
